-- MagTrace · Supabase schema (MVP Finca La Esperanza)
-- Fuente canónica: supabase/migrations/20260529000000_magtrace_schema.sql
-- Aplicar con CLI: pnpm db:push  (proyecto cloud) o pnpm db:reset (local + Docker)
...
-- Lotes (slug = URL pública, ej. finca-la-esperanza)
...
-- Experiencias vinculadas a un lote
...
-- Proveedores por experiencia (agencia u operador directo)
...
-- Lectura pública (vista QR + tours)
...
-- Pedidos: cualquiera puede crear (MVP demo); lectura restringida
